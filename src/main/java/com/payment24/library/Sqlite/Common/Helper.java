...
import Payment24.Sqlite.TableColumn;
import Payment24.Sqlite.TableQuery;
...
public class Helper {
    ...
    public static Table GetEntityTable(Entity entity) {
        ...
        if (entity.getClass().isAnnotationPresent(Payment24.Sqlite.Attributes.Table.class)) {

            Payment24.Sqlite.Attributes.Table attrTable = entity.getClass().getAnnotation(Payment24.Sqlite.Attributes.Table.class);
